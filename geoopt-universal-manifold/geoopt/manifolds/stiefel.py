...
class CanonicalStiefel(Stiefel):
  ...
  def inner(self, x: torch.Tensor, u: torch.Tensor, v: torch.Tensor = None, *, 
  ...
  def _transp_follow_one(self, x: torch.Tensor, v: torch.Tensor, *, 
...
class EuclideanStiefelExact(EuclideanStiefel):
  ...
  """.format(EuclideanStiefel.__doc__)
