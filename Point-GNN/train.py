...
train_config_path   = os.path.join(script_dir, 'configs/car_auto_T0_train_train_config')
config_path         = os.path.join(script_dir, 'configs/car_auto_T0_train_config')
dataset_root_dir    = os.path.join(script_dir, 'dataset/kitti/')
